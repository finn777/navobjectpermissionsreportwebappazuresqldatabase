package navobjectpermissionsreportwebappazuresqldatabase.controllers;

import java.util.*;

import navobjectpermissionsreportwebappazuresqldatabase.models.*;
...
public class MainController {
    ...
    public ArrayList<Row> getRows(String objecttype, Long objectid, Long objectid2) {
        ...
        for (int i = 0; i < data.size(); i++) {
            ...
            String.valueOf(data.get(i).getPread()),
            String.valueOf(data.get(i).getPinsert()),
            String.valueOf(data.get(i).getPmodify()),
            String.valueOf(data.get(i).getPdelete()),
            String.valueOf(data.get(i).getPexecute()),
